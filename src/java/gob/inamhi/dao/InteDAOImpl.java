...
@Repository("InteDAO")
@Transactional
public class InteDAOImpl implements InteDAO {

    @Autowired
    //@Qualifier("SessionFactory1")
    private SessionFactory sessionFactory;
    private final static Set<Class<?>> dataTypes = new HashSet<Class<?>>(Arrays.asList(new Class<?>[]{Inte.class}));
    ...
    public Set<Inte> findAllIntes() throws DataAccessException {
        ...
        return new LinkedHashSet<Inte>(query.list());
    }

    public boolean canBeMerged(Inte entity) {
        return true;
    }
